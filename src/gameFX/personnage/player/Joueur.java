package gameFX.personnage.player;

import gameFX.item.Item;
import gameFX.item.Weapon;
import gameFX.item.equipment.Equipment;
import gameFX.personnage.player.classe.ClasseJoueur;
import gameFX.personnage.pnj.PNJ;
